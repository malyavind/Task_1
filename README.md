...
users_per_thread - количество пользователей, которое клиент будет обслуживать на одном потоке. При привышении этого количество клиентов создается новый поток.
